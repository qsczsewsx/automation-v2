...
public class StgTcbCustomer {
  ...
  public boolean equals(Object o) {
    ...
    StgTcbCustomer that = (StgTcbCustomer) o;
  ...
  public boolean saveOrUpdateCustomer(StgTcbCustomer customer) {
    try {
  ...
  public List<StgTcbCustomer> findByTcbsId(List<String> listTcbsId) {
    ...
    Query<StgTcbCustomer> query = Staging.stagingDbConnection.getSession().createQuery(
      "from com.tcbs.automation.staging.StgTcbCustomer as cus "
        + " where cus.tcbsid in :listTcbsId "
        + " AND cus.etlCurDate = (SELECT MAX(b.etlCurDate) FROM com.tcbs.automation.staging.StgTcbCustomer as b) "
