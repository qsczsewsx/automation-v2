...
@Entity
@Table(name = "TCBS_IAGENT_VIDEO_CALL")
public class TcbsIagentVideoCall {
  ...
  public TcbsIagentVideoCall(String userId, String zoomUserId, String videoCallType, String meetingId, String meetingStatus, String meetingRequestBody, String meetingResponseBody, Date meetingRequestDate, String meetingStartedPayload, String meetingEndedPayload, Date startMeetingTime, Date endMeetingTime, String recordingStartedPayload, String recordingCompletedPayload, String customerInfo, String downloadStatus, String downloadFileLocation, String deleteRecordingFileStatus, Date createdDate, Date updatedDate) {
    this.userId = userId;
  ...
  @Step
  public TcbsIagentVideoCall getVideoCallByUserId(String userId) {
    Session session = CAS.casConnection.getSession();
    session.clear();
    Query<TcbsIagentVideoCall> query = session.createQuery("from TcbsIagentVideoCall where userId=:userId order by id desc", TcbsIagentVideoCall.class);
    TcbsIagentVideoCall result = new TcbsIagentVideoCall();
  ...
  @Step
  public TcbsIagentVideoCall getVideoCallByMeetingId(String meetingId) {
    Session session = CAS.casConnection.getSession();
    session.clear();
    Query<TcbsIagentVideoCall> query = session.createQuery("from TcbsIagentVideoCall where meetingId=:meetingId order by id desc", TcbsIagentVideoCall.class);
    TcbsIagentVideoCall result = new TcbsIagentVideoCall();
  ...
  @Step
  public TcbsIagentVideoCall getStatusMeeting(String meetingStatus) {
    Session session = CAS.casConnection.getSession();
    session.clear();
    Query<TcbsIagentVideoCall> query = session.createQuery("from TcbsIagentVideoCall where meetingStatus=: meetingStatus", TcbsIagentVideoCall.class);
