...
public class R3RdAuditLog {
  ...
  @Step
  public static List<R3RdAuditLog> getHistoryByTcbsId(String tcbsId) {
    CAS.casConnection.getSession().clear();
    Query<R3RdAuditLog> query = CAS.casConnection.getSession().createQuery(
      "from R3RdAuditLog a where a.tcbsId =: tcbsId order by createdDate desc", R3RdAuditLog.class);
