...
public class Daily01CusEntity {
  @Step("Get stock from BPM")
  public static List<HashMap<String, Object>> getCustomerBpm(String type) {
    StringBuilder queryBuilder = new StringBuilder();
    queryBuilder.append(" select * from RISK_CUSTOMER_DAILY_TRACKING where ETL_UPDATE_DATE = (select max(ETL_UPDATE_DATE) from RISK_CUSTOMER_DAILY_TRACKING where type = :type) and type = :type   ");
    try {
  ...
  public static List<HashMap<String, Object>> getCustomerStg(List<String> tickers) {
    ...
    queryBuilder.append(
      " select distinct a.CUSTODYCD, AFACCTNO, FULLNAME, MARGINAMT, TOTALVND, b.ACTYPE AC_TYPE, b.MARGINRATE MARGIN_RATE,b.MRIRATE MRI_RATE,b.MRMRATE MRM_RATE,b.MRLRATE MRL_RATE, b.TOTALVND TOTAL_VND, SEASS,  ");
