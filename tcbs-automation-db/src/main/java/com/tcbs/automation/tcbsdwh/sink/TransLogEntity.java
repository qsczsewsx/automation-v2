...
public class TransLogEntity {
  ...
  public static List<HashMap<String, Object>> select() {
    ...
    queryBuilder.append("SELECT * FROM stockmarket_data.TRANS_LOG");
  ...
  public static void truncateData() {
    ...
    org.hibernate.query.Query<?> query = session.createNativeQuery("truncate table stockmarket_data.TRANS_LOG");
    query.executeUpdate();
    trans.commit();
  }
}
