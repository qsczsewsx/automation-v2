...
@Entity
@Table(name = "MonthlyPort_BondTxn")
public class MonthlyPortBondTxnEntity {
  private Date txDate;
  @Id
  ...
  @Step("Get data")
  public static List<HashMap<String, Object>> getBondTxn(String custodyCd) {
    StringBuilder queryStringBuilder = new StringBuilder();
    queryStringBuilder.append(" select custodyCd, txDate, action, underlying, quantity, amount, tradingCode  ");
    queryStringBuilder.append(" from MonthlyPort_BondTxn  ");
  ...
  public boolean equals(Object o) {
    ...
    MonthlyPortBondTxnEntity that = (MonthlyPortBondTxnEntity) o;
