...
@UseTestDataFrom(value = "data/trackingcustomeruploadidentifycard/InvalidTrackingCustomerUploadIdentifyCardBody.csv", separator = '|')
public class TrackingCustomerUploadIdentifyCardInvalidBodyTest {
  private Actor user;
  ...
  @Title("Tracking customer upload identify card with invalid body")
  public void tracking_customer_upload_identity_card_with_invalid_body() {
