...
@UseTestDataFrom(value = "data/trackingcustomeruploadidentifycard/SuccessTrackingCustomerUploadIdentifyCardBody.csv", separator = '|')
public class TrackingCustomerUploadIdentifyCardSuccessTest {
  private Actor user;
  ...
  @Title("Tracking customer upload identify card with valid body")
  public void tracking_customer_upload_identity_card_with_valid_body() {
