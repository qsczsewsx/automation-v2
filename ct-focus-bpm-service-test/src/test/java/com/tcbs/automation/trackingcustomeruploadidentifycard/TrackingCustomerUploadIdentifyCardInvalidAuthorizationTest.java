...
@UseTestDataFrom(value = "data/trackingcustomeruploadidentifycard/InvalidTrackingCustomerUploadIdentifyCardAuthorization.csv", separator = '|')
public class TrackingCustomerUploadIdentifyCardInvalidAuthorizationTest {
  private Actor user;
  ...
  @Title("Tracking customer upload identify card with invalid authorization")
  public void tracking_customer_upload_identity_card_with_invalid_authorization() {
