...
@UseTestDataFrom(value = "data/authen/AuthenSession.csv", separator = '|')
public class AuthenSessionTest {
  @Getter
  ...
  @Title("Verify api authen session")
  public void updateSessionTest() {
    System.out.println("TestcaseName : " + testCaseName);

    Response response = callApiUpdateSession(body, testCaseName);
    ...
    if (statusCode == 200) {
      ...
      assertEquals("TCINVEST", newClaims.get("otpSource"));
  ...
  public static Response callApiUpdateSession(HashMap body, String testCaseName) {
    RequestSpecification requestSpecification = given()
      .baseUri(xxxxProfileServiceConfig.UPDATE_SESSION)
      .header("x-api-key", xxxxProfileServiceConfig.xxxxPROFILE_INQUIRYGROUPINFOKEY)
