...
public enum Database {
  ...
  TIMELINE("timeline"),
  DWH("dwh"),
  AWS_xxxx_DWH("aws_xxxx_dwh"),
  xxxx_DWH("xxxx_dwh"),
  xxxx_DWH_WRITE("xxxx_dwh_write"),
  xxxx_DWH_STAGING("xxxx_dwh_staging"),
  ...
  IVOUCHER("ivoucher"),
  TCA("tca"),
  REDSHIFT_STAGING("xxxx_dwh_staging"),
  REDSHIFT_STOCK_MARKET("xxxx_dwh_stockmarket_data"),
