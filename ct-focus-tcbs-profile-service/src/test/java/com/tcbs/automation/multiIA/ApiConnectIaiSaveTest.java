...
@UseTestDataFrom(value = "data/multiIA/ApiConnectIaiSaveTest.csv", separator = '|')
public class ApiConnectIaiSaveTest {
  @Getter
  ...
  @Title("Verify api connect IA iSave")
  public void verifyConnectIaiSaveTest() {
    ...
    if (statusCode == 200) {
      assertThat("verify connect ia isave success", TcbsBankIaaccount.getIaiSaveBank(userId, "ISAVE"), is(new BigDecimal(1)));
