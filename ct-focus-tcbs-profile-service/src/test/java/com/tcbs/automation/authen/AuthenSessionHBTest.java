...
import static com.tcbs.automation.config.tcbsprofileservice.TcbsProfileServiceConfig.UPDATE_SESSION_HB;
import static com.tcbs.automation.config.tcbsprofileservice.TcbsProfileServiceConfig.UPDATE_SESSION_HB_TOKEN;
...
public class AuthenSessionHBTest {
  ...
  public static Response callApiUpdateSessionHB(HashMap body, String testCaseName) {
    RequestSpecification requestSpecification = given()
      .baseUri(UPDATE_SESSION_HB)
      .header("x-api-key", UPDATE_SESSION_HB_TOKEN)
