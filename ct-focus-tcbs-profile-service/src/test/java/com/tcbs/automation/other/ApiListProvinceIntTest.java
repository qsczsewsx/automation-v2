...
@UseTestDataFrom(value = "data/other/ApiListProvinceInt.csv", separator = '|')
public class ApiListProvinceIntTest {
  ...
  @Title("Verify api list province int")
  public void verifyListProvinceIntTest() {
    System.out.println("TestCaseName : " + testCaseName);

    RequestSpecification request = given()
      .baseUri(LIST_PROVINCE_INT)
      .header("x-api-key", testCaseName.contains("user has no permission") ? TCBSPROFILE_AUTHORIZATION : API_KEY);
