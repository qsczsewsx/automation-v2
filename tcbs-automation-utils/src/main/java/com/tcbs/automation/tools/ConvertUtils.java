...
public class ConvertUtils {
  ...
  public static String convertTcbsIdTo105C(String tcbsid) {
    TcbsUser tcbsUser = new TcbsUser();
    return tcbsUser.getByTcbsId(tcbsid).getUsername();
  }
  ...
  public static String convert105CToTcbsId(String username) {
    TcbsUser tcbsUser = new TcbsUser();
    return tcbsUser.getByUserName(username).getTcbsid();
  }
